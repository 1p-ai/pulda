...
<section class="case-map" aria-label="정보 구조 지도">
...
<section class="design-tokens" aria-label="디자인 토큰">
  ...
  <div style="--swatch:#9f3a32"><span></span><strong>Old Red</strong><small>#9f3a32</small></div>
  <div style="--swatch:#050914"><span></span><strong>Tech Navy</strong><small>#050914</small></div>
...
<section class="system-flow" aria-label="운영 시스템 흐름">
  <div><strong>Markdown</strong><span>초기 콘텐츠</span></div>
  <i></i>
  <div><strong>Astro Build</strong><span>정적 페이지 생성</span></div>
  <i></i>
...
<section class="result-metrics" aria-label="프로젝트 결과 요약">
  <div><strong>7+</strong><span>정적 라우트와 콘텐츠 상세</span></div>
  <div><strong>2</strong><span>라이트/다크 브랜드 모드</span></div>
  <div><strong>11</strong><span>프로젝트 표준 산출물 문서</span></div>
  <div><strong>1</strong><span>콘텐츠 어드민 초안</span></div>
</section>
